"""
Django settings for PersonalizedWorkoutPlan project.
...
AUTH_USER_MODEL = "PersonalizedWorkoutPlanApp.AppUser"
...
WSGI_APPLICATION = 'PersonalizedWorkoutPlan.wsgi.application'
